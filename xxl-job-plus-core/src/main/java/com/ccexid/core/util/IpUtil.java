 ...
 * ip tool
 *
 * @author xuxueli 2016-05-22 11:38:05
 */
@Slf4j
public class IpUtil {
     ...
     * @return true if the address is valid IPv4 address, false otherwise
     */
     ...
     *
     * @param address the address string in format "ip:port"
     * @return Object array contains host and port
     */
